...
const AnimatedWave: React.FC<AnimatedWaveProps> = ({
      ...
      moveNoise: function (mouse: { x: number; y: number }) {
        ...
        for (let i = 0; i < positions.count; i++) {
          ...
          if (mouseInteraction && this.mouseDistortionStrength > 0) {
            ...
            // Generate a 2D Simplex noise value for the ripple with time component.
            // We incorporate time by adding it to one of the coordinates.
            const mouseRippleNoise = this.simplex(
              distX_mouse / this.mouseDistortionSmoothness, // Smoothness of the mouse ripple
              distY_mouse / this.mouseDistortionSmoothness + this.distortionTime // Time-based evolution
  ...
  return (
    <div
      ...
      style={{
        // Allow pointer events for mouse interaction with the wave
        pointerEvents: "auto",
