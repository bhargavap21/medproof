...
/**
 * MedProof MVP Deployment Script
 * Deploys the simplified medproof-mvp contract
 */
...
async function main() {
  ...
  // Deploy
  console.log('🚀 Deploying MVP contract...\n');
